...
```mermaid
graph LR
    P0["Phase 0<br/>Pronunciation<br/>Days 1–20"] --> P1["Phase 1<br/>Core Speech Acts<br/>Days 21–60"]
    P1 --> P2["Phase 2<br/>Workplace Speaking<br/>Days 61–90"]
    P2 --> P3["Phase 3<br/>Writing<br/>Days 91–130"]
    P3 --> P4["Phase 4<br/>Discourse & Nuance<br/>Days 131–160"]
    P4 --> P5["Phase 5<br/>Capstone<br/>Days 161–180"]
    style P0 fill:#eafaf1,stroke:#27ae60,stroke-width:3px
    style P5 fill:#eaf2f8,stroke:#2980b9,stroke-width:3px
```
